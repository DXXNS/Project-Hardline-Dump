	...
	private void OnGUI()
	{
		...
		if (showList)
		{
			...
			foreach (CameraShakeInstance shakeInstance in CameraShaker.Instance.ShakeInstances)
			{
				...
				Vector3 positionInfluence = shakeInstance.PositionInfluence;
				GUILayout.Label("      Position Influence: " + positionInfluence.ToString());
				positionInfluence = shakeInstance.RotationInfluence;
				GUILayout.Label("      Rotation Influence: " + positionInfluence.ToString());
